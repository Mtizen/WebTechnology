    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0">Cập nhật Vấn Đề</h4>
            </div>
            <div class="card-body">
                <div class="alert alert-primary">
                    Bạn đang chỉnh sửa vấn đề có mã: <strong>{{ $issues->id }}</strong>
                </div>
                <form action="{{ route('home.update', $issues->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="reported_date" name="reported_date" value="{{ $issues->reported_date }}" step="1" min="0000-01-01T00:00:00" max="9999-12-31T23:59:59" required>
                    </div>
